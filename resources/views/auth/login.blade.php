                ...
                <form class="form-horizontal form-material" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            </div> <a href="{{ route('password.request') }}" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Forgot password?</a> 
                        </div>
                    </div>
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="{{ route('registerStore') }}" class="text-info m-l-5"><b>Sign Up</b></a></p>
                        </div>
                    </div>
                </form>
            </div>
