    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <form action="{{ route('userAdd') }}" method="POST" autocomplete="off">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="col-xs-4 col-sm-4 col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <select
                                                                    id="choose"
                                                                    name="kind"
                                                                    class="form-control{{ $errors->has('kind') ? ' is-invalid' : '' }}"
                                                                    value="{{ old('kind') }}"
                                                                    required="required"
                                                                    autofocus="autofocus"
                                                                    placeholder="Choose">
                                                    ...
                                                    <a href="#company">
                                                        <button id="scd" type="button" class="btn btn-outline-danger btn-sm">
                                                            <strong>Down the next step</strong>
                                                        </button>
                                                    </a>
                                                    <a href="#address">
                                                        <button id="sca1" type="button" class="btn btn-outline-danger btn-sm">
                                                            <strong>Down the next step</strong>
                                                        </button>
                                                    </a>
