                                    ...
                                    <div class="table-responsive">
                                        <table id="task" class="display nowrap table table-hover table-striped table-bordered dataTable table-sm"
                                            ...
                                            <tr>
                                                ...
                                                <th>Memory (GB)</th>
                                                <th>Disc</th>
                                                <?php if($name->name=="Warriors Defender Mail"): ?>
                                                    <th
                                                        class="sorting"
                                                        tabindex="0"
                                                ...
                                                <?php endif; ?>
                                                <?php if($name->name=="Warriors Defender Storage"): ?>
                                                    <th
                                                        class="sorting"
                                                        tabindex="0"
                                                        aria-controls="example23"
                                        ...
                                        <input hidden type="text" id="mail" value="<?php echo e($name->name); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $(document).ready(function() {
        ...
        if(mail=="Warriors Defender Mail"){
            oTable = $('#task').DataTable({
                // processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('datatableproducts',"$prodid")); ?>",
                columns: [
                    {data: 'maker'},
                    {data: 'processor'},
                    {data: 'memory'},
