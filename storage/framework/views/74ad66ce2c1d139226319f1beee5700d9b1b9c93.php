                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div id="contact" class="card">
                                ...
                                <form action="<?php echo e(route('companyUpdateCompany',$compan->id)); ?>" 
                                    method="POST" 
                                        ...
                                        <div class="row">
                                            <div class="col-xs-3 col-sm-3 col-md-3">
                                                ...
                                                <div class="el-card-avatar el-overlay-1">
                                                    <img
                                                        src="<?php echo e(Storage::url($compan->companyimg)); ?>"
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="<?php echo e($compan->companyname); ?>"
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="<?php echo e($compan->companyrfc); ?>"
                                                                        required
                                                                        maxlength="13"
                                                                        pattern="[A-Z0-9].{12}"
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="<?php echo e($compan->companytelephone1); ?>"
                                                                    ...
                                                                    <?php switch(true):
                                                                        case ($compan->companytelephone2=="000-000-0000"): ?>
                                                                            <input
                                                                                ...
                                                                                placeholder="5523212321">
                                                                            <?php break; ?>
                                                                        <?php case ($compan->companytelephone2!="000-000-0000"): ?>
                                                                            <input
                                                                                type="text"
                                                                                data-mask="000-000-0000"
                                                                                id="ctele"
                                                                                class="form-control "
                                                                                value="<?php echo e($compan->companytelephone2); ?>"
                                                                                placeholder="5523212321">
                                                                            <?php break; ?>
                                                                    <?php endswitch; ?>
                                                                    <?php switch(true):
                                                                        case ($compan->companytelephone2==""): ?>
                                                                            <input
                                                                                ...
                                                                                data-validation-pattern-message="The telephone number must have 10 digits">
                                                                            <?php break; ?>
                                                                        <?php case ($compan->companytelephone2!=""): ?>
                                                                            <input
                                                                                hidden
                                                                                type="text"
                                                                                data-mask="000-000-0000"
                                                            ...
                                                            <div class="controls">
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <input
                                                                        ...
                                                                        value="<?php echo e($compan->companyemail1); ?>"
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    <?php switch(true):
                                                                        case ($compan->companyemail2=="default@default.com"): ?>
                                                                            ...
                                                                            <?php break; ?>
                                                                        <?php case ($compan->companyemail2!="default@default.com"): ?>
                                                                            <input
                                                                                type="text"
                                                                                id="cem2"
                                                                                class="form-control "
                                                                                value="<?php echo e($compan->companyemail2); ?>"
                                                                                placeholder="example: example@exam.com">
                                                                            <?php break; ?>
                                                                    <?php endswitch; ?>
                                                                    <?php switch(true):
                    ...
                    <div class="row ">
                        <div class="col-md-12">
                            ...
                            <div id="profile" class="card">
                                    <!---->
                                <form action="<?php echo e(route('companyUpdateProfile',[$contact->id, $compan->id])); ?>"
                                    method="POST" 
                                    enctype="multipart/form-data"
                                    autocomplete="off"
                                    novalidate>
                                    <div class="card-block">                                                
                                        ...
                                        <div class="row">
                                            <div class="col-xs-5 col-sm-5 col-md-5">
                                                <div class="form-group">
                                                <!-- <input id="area" type="textarea" value="<?php echo e($contact->area); ?>"> -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div id="information" class="card">
                                <form action="<?php echo e(route('companyUpdateAddress',$compan->id)); ?>" method="POST" autocomplete="off" novalidate>
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                value="<?php echo e($compan->zipcode); ?>"
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                value="<?php echo e($compan->district); ?>"
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                value="<?php echo e($compan->street); ?>"
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                value="<?php echo e($compan->exteriornumber); ?>"
                                                    ...
                                                    <div class="controls">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input
                                                                ...
                                                                name="innumber"
                                                                class="form-control "
                                                                value="<?php echo e($compan->insidenumber); ?>"
